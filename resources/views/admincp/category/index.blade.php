                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                {!! Form::open(['method'=>'DELETE','route'=>['category.destroy',$cate->id],'onsubmit'=>'return confirm("Xóa danh mục này?")']) !!}
                                    {!! Form::submit('Xóa', ['class'=>'btn btn-sm btn-danger']) !!}
                                {!! Form::close() !!}
                                <a href="{{ route('category.edit',$cate->id) }}" class="btn btn-sm btn-warning">Sửa</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
