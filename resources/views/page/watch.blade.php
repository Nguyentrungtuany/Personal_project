    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
        <section id="content" class="test">
            <div class="clearfix wrap-content">
                ...
                {{-- <video id="player" controls width="100%" height="500"></video> --}}
                            ...
                            <div class="halim-server">
                                <ul class="halim-list-eps">
                                    ...
                                    <li style="display: flex" class="halim-episode"><span
                                            class=" halim-btn halim-btn-2 halim-info-1-2 box-shadow">{{$ser->title}}</span>
                                    </li>
                                    <ul class="halim-list-eps">
                                        ...
                                        <a
                                            ...
                                            <li class="halim-episode"><span
                                                    class="{{$tapphim==$epi->episode && $server_active=='server-'.$ser->id ?  'active' : ''}} halim-btn halim-btn-2 halim-info-1-2 box-shadow"
