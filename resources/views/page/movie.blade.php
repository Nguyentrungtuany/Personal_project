                ...
                <div class="halim-movie-wrapper">
                    ...
                    <div class="movie_info col-xs-12">
                        <div class="movie-poster col-md-3">
                            ...
                            @else
                            <a href="#watch_trailer" style="display:block ;" class="btn btn-primary watch-trailer">Xem
                                Trailer</a>
                            @endif
                        </div>
                        <div class="film-poster col-md-9">
                            ...
                            <ul class="list-info-group">
                                <li class="list-info-group-item"><span>Trạng Thái</span> : <span
                                        class="quality">@if($movie->resolution==0)
                                        HD
                                ...
                                <li class="list-info-group-item"><span>Tập phim mới nhất</span> :
                                    ...
                                    <a href="{{ url('xem-phim/'.$movie->slug.'/tap-'.$ep_le->episode) }}" rel="tag">
                                        {{$ep_le->episode}} </a>
                                    @endforeach
                                ...
                                <ul class="list-inline rating" title="Average Rating">
                                    ...
                                    @for($count=1; $count<=5; $count++) @php if($count<=$rating){
                                        ...
                                        title="star_rating" id="{{$movie->id}}-{{$count}}" data-index="{{$count}}"
                                        data-movie_id="{{$movie->id}}" data-rating="{{$rating}}" class="rating" style="cursor:pointer; {{$color}}
                    ...
                    <div class="entry-content htmlwrap clearfix">
                        <div class="video-item halim-entry-box">
                            <article id="post-38424" class="item-content">
                                ...
                                @endphp
                                <div class="fb-comments" data-colorscheme="light" data-href="{{$current}}"
                            ...
                            <a class="halim-thumb" href="{{ route('movie',$movie->slug) }}" title="{{ $movie->title }}">
                                ...
                                <span class="status">@if($movie->resolution==0)
                                    ...
                                    @endif</span><span class="episode"><i class="fa fa-play"
                                        aria-hidden="true"></i>@if($movie->phude==0)
                                    Phụ đề
                                    @if($movie->season!=0)
                                    - Season {{ $movie->season }}
                                    @endif
