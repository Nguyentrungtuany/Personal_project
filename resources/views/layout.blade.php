...
<body class="home blog halimthemes halimmovies" data-masonry="">
                     ...
                     <form id="search-form-pc" name="halimForm" role="search" action="{{route('tim-kiem')}}" method="GET">
                        <div class="form-group">
                           <div class="input-group col-xs-12">
                              <input id="timkiem" type="text" name="search" class="form-control" placeholder="Tìm kiếm..."
                  ...
                  <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                     ...
                     <li class="mega dropdown">
                        ...
                        <ul role="menu" class=" dropdown-menu">
                           ...
                           <li><a title="{{ $gen->title }}" href="{{ route('genre', $gen->slug) }}">{{ $gen->title
                                 }}</a></li>
                           @endforeach
                        </ul>
                     </li>
   ...
   <div id="fb-root"></div>
   <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v23.0&appId=1169036544029114"></script>
